...
import LazyBarcodeCache from '@mhma_stock_barcode/lazy_barcode_cache';
...
export default class BarcodeModel extends EventBus {
    ...
    async processBarcode(barcode) {
        return this.actionMutex.exec(() => this._processBarcode(barcode));
    }
    ...
    async _processBarcode(barcode) {
        ...
        try {
            ...
            barcodeData.error =
                ...
                (err && err.message) ||
                (typeof err === "string" ? err : _t("Please, Scan again!"));
        }
