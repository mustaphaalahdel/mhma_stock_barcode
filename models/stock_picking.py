...
class StockPicking(models.Model):
    ...
    def action_cancel_from_barcode(self):
        self.ensure_one()
        view = self.env.ref('mhma_stock_barcode.stock_barcode_cancel_operation_view')
        return {
    ...
    def action_open_picking_client_action(self):
        ...
        """
        self.ensure_one()
        action = self.env["ir.actions.actions"]._for_xml_id("mhma_stock_barcode.stock_barcode_picking_client_action")
    ...
    def _get_stock_barcode_data(self):
        ...
        data['line_view_id'] = self.env.ref('mhma_stock_barcode.stock_move_line_product_selector').id
        data['form_view_id'] = self.env.ref('mhma_stock_barcode.stock_picking_barcode').id
        data['package_view_id'] = self.env.ref('mhma_stock_barcode.stock_quant_barcode_kanban').id
        return data
    ...
    def filter_on_barcode(self, barcode):
        ...
        action = picking_type._get_action('mhma_stock_barcode.stock_picking_action_kanban')
...
class StockPickingType(models.Model):
    ...
    def get_action_picking_tree_ready_kanban(self):
        return self._get_action('mhma_stock_barcode.stock_picking_action_kanban')
