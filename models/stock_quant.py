...
class StockQuant(models.Model):
    ...
    def action_client_action(self):
        ...
        """
        action = self.env['ir.actions.actions']._for_xml_id('mhma_stock_barcode.stock_barcode_inventory_client_action')
    ...
    def _get_stock_barcode_data(self):
        ...
        data['line_view_id'] = self.env.ref('mhma_stock_barcode.stock_quant_barcode').id
        return data
